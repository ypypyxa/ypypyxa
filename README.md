...
## 🚀 Текущий проект
Сейчас разрабатываю **API** для онлайн-приложения, чтобы изучить **авторизацию пользователей, пуш-уведомления и возможности Firebase**. Планирую интеграцию платёжной системы, чтобы в будущем этот проект мог использоваться в **интернет-магазинах, пиццериях и службах доставки**.
