...
## 🚀 Текущий проект
Сейчас работаю над **API** для онлайн-приложения, чтобы изучить **авторизацию пользователей, пуш-уведомления и другие возможности Firebase**. Планирую интеграцию платёжной системы, чтобы в будущем этот проект мог использоваться в **интернет-магазинах, пиццериях и службах доставки или иных онлайн-приложениях**.
